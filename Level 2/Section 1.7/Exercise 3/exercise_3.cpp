...
for (i=0; i<=4; i++) PRD(a[i]); // 1 will print 01234
NL;

for (p=&a[0]; p<=&a[4]; p++) PRD(*p); // 2 will print 01234
NL;
NL;
...
for (p=a+4, i=0; i<=4; i++) PRD(p[-i]); // 6  43210  negative index works like python
NL;
